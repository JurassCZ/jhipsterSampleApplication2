...
import kacirekj.test.jhipster.config.audit.AuditEventConverter;
import kacirekj.test.jhipster.domain.PersistentAuditEvent;
...
import static kacirekj.test.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
