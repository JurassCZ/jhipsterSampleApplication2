package kacirekj.test.jhipster.web.rest;

import kacirekj.test.jhipster.config.Constants;
import kacirekj.test.jhipster.JhipsterSampleApplication2App;
import kacirekj.test.jhipster.domain.Authority;
import kacirekj.test.jhipster.domain.PersistentToken;
import kacirekj.test.jhipster.domain.User;
import kacirekj.test.jhipster.repository.AuthorityRepository;
import kacirekj.test.jhipster.repository.PersistentTokenRepository;
import kacirekj.test.jhipster.repository.UserRepository;
import kacirekj.test.jhipster.security.AuthoritiesConstants;
import kacirekj.test.jhipster.service.MailService;
import kacirekj.test.jhipster.service.dto.UserDTO;
import kacirekj.test.jhipster.service.dto.PasswordChangeDTO;
import kacirekj.test.jhipster.web.rest.errors.ExceptionTranslator;
import kacirekj.test.jhipster.web.rest.vm.KeyAndPasswordVM;
import kacirekj.test.jhipster.web.rest.vm.ManagedUserVM;
import kacirekj.test.jhipster.service.UserService;
